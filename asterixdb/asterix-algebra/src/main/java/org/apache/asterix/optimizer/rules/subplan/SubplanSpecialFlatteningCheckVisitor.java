...
class SubplanSpecialFlatteningCheckVisitor implements IQueryOperatorVisitor<Boolean, Void> {
    ...
    @Override
    public Boolean visitMarkerSinkOperator(MarkerSinkOperator op, Void arg) throws AlgebricksException {
        return visitInputs(op);
    }
    ...
    @Override
    public Boolean visitFixedPointOperator(FixedPointOperator op, Void arg) throws AlgebricksException {
        return false;
    }

    @Override
    public Boolean visitRecursiveTailOperator(RecursiveTailOperator op, Void arg) throws AlgebricksException {
        return false;
    }

    @Override
    public Boolean visitRecursiveHeadOperator(RecursiveHeadOperator op, Void arg) throws AlgebricksException {
        return false;
    }
