...
public class BTreeSearchPOperator extends IndexSearchPOperator {
    ...
    protected final List<LogicalVariable> lowKeyVarList;
    protected final List<LogicalVariable> highKeyVarList;
    protected final boolean isPrimaryIndex;
    protected final boolean isEqCondition;
    ...
    protected BTreeSearchPOperator(BTreeSearchPOperator pOp) {
        super(pOp);
        this.isPrimaryIndex = pOp.isPrimaryIndex;
        this.isEqCondition = pOp.isEqCondition;
        this.lowKeyVarList = pOp.lowKeyVarList;
        this.highKeyVarList = pOp.highKeyVarList;
    }
