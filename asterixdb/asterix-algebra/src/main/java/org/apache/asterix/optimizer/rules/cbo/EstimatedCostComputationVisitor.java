...
public class EstimatedCostComputationVisitor implements ILogicalOperatorVisitor<Pair<Double, Double>, Double> {
    ...
    @Override
    public Pair<Double, Double> visitMarkerSinkOperator(MarkerSinkOperator op, Double arg) throws AlgebricksException {
        return annotate(this, op, arg);
    }
    ...
    @Override
    public Pair<Double, Double> visitFixedPointOperator(FixedPointOperator op, Double arg) throws AlgebricksException {
        return annotate(this, op, arg);
    }

    @Override
    public Pair<Double, Double> visitRecursiveTailOperator(RecursiveTailOperator op, Double arg)
            throws AlgebricksException {
        return annotate(this, op, arg);
    }

    @Override
    public Pair<Double, Double> visitRecursiveHeadOperator(RecursiveHeadOperator op, Double arg)
            throws AlgebricksException {
        return annotate(this, op, arg);
    }
