 ...
 * </ul>
 */
public class SetAsterixMemoryRequirementsRule extends SetMemoryRequirementsRule {
    ...
    protected boolean forceMinMemoryBudget(AsterixOptimizationContext context) {
