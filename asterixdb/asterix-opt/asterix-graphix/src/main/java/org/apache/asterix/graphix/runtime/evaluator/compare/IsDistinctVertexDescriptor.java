            ...
            public IScalarEvaluator createScalarEvaluator(IEvaluatorContext ctx) throws HyracksDataException {
                return new AbstractElementCompareEvaluator() {
                    ...
                    protected boolean readTuple(IFrameTupleReference tuple, IPointable result)
                        ...
                        if (PointableHelper.checkAndSetMissingOrNull(result, vertexArgPtr, pathArgPtr)) {
                            return false;
                        }
                        ...
                        vertexListItemCallback.set(vertexArgPtr);
                    ...
                    protected boolean compare() throws HyracksDataException {
                        SinglyLinkedListPointable vertexListPointable = pathPtr.getVertexListPointable();
                        while (vertexListPointable.hasNext()) {
                            vertexListPointable.next();
                            if (vertexListItemCallback.isMatchFound()) {
                                return true;
                            }
                        }
                        return false;
