...
public class PathHopCountTypeComputer extends AbstractResultTypeComputer {
    public static final PathHopCountTypeComputer INSTANCE = new PathHopCountTypeComputer();
    ...
    private PathHopCountTypeComputer() {
    }
}
