...
public class VertexSingleNestedAction implements IEnvironmentAction {
    private final VertexPatternExpr vertexPatternExpr;

    public VertexSingleNestedAction(VertexPatternExpr vertexPatternExpr) {
    ...
    public void apply(LoweringEnvironment loweringEnvironment) throws CompilationException {
        ...
        VariableExpr iterationVar = rewritingContext.getGraphixVariableCopy(vertexVar);
        ...
        if (filterExpr != null) {
            loweringEnvironment.acceptAction(new FilterExpressionAction(filterExpr, vertexVar, iterationVar));
        }
        ...
        loweringEnvironment.acceptTransformer(clauseSequence -> {
            ...
            clauseSequence.setVertexBinding(vertexVar, iterationVarCopy2);
        });
