...
public class IsDistinctTypeComputer extends AbstractResultTypeComputer {
    public static final IsDistinctTypeComputer INSTANCE = new IsDistinctTypeComputer();
    ...
    private IsDistinctTypeComputer() {
    }
}
