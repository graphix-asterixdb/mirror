...
class TigerGraphBenchmarkClient(AbstractBenchmarkClient):
    def __init__(self):
        parser = argparse.ArgumentParser(description='Benchmark LDBC SNB queries on a TigerGraph instance.')
        ...
        parser.add_argument('--uri', type=str, default='localhost', help='URI pointing to the TigerGraph endpoint.')
        parser.add_argument('--graphName', type=str, default='LDBC', help='Name of graph to connect to.')
        ...
        parser.add_argument('--config', type=str, default='config/tigergraph.json',
        ...
        result_file = parser_args.resultsDir + f'/tigergraph_{date_string}.json'
        log_file = parser_args.logDir + f'/tigergraph_{date_string}.log'
        ...
        client_config = {
            ...
            'graphName': parser_args.graphName,
            'host': parser_args.uri
        }
        ...
        super().__init__(set(), parameter_files, result_file, log_file, parser_args.restartCmd, specification,
