...
import org.apache.hyracks.algebricks.core.algebra.operators.physical.MarkerSinkPOperator;
...
public class SetAlgebricksPhysicalOperatorsRule implements IAlgebraicRewriteRule {
    ...
    protected static class AlgebricksPhysicalOperatorFactoryVisitor
        ...
        @Override
        public IPhysicalOperator visitMarkerSinkOperator(MarkerSinkOperator op, Boolean arg) {
            return new MarkerSinkPOperator();
        }
        ...
        @Override
        public IPhysicalOperator visitFixedPointOperator(FixedPointOperator op, Boolean arg)
                throws AlgebricksException {
            throw AlgebricksException.create(ErrorCode.PHYS_OPERATOR_NOT_SET, op.getSourceLocation(),
                    op.getOperatorTag());
        }
        ...
        @Override
        public IPhysicalOperator visitRecursiveTailOperator(RecursiveTailOperator op, Boolean arg)
                throws AlgebricksException {
            throw AlgebricksException.create(ErrorCode.PHYS_OPERATOR_NOT_SET, op.getSourceLocation(),
                    op.getOperatorTag());
        }
        ...
        @Override
        public IPhysicalOperator visitRecursiveHeadOperator(RecursiveHeadOperator op, Boolean arg)
                throws AlgebricksException {
            throw AlgebricksException.create(ErrorCode.PHYS_OPERATOR_NOT_SET, op.getSourceLocation(),
                    op.getOperatorTag());
        }
