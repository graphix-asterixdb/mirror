...
public class CardinalityInferenceVisitor implements ILogicalOperatorVisitor<Long, Void> {
    ...
    @Override
    public Long visitMarkerSinkOperator(MarkerSinkOperator op, Void arg) throws AlgebricksException {
        return op.getInputs().get(0).getValue().accept(this, arg);
    }
    ...
    @Override
    public Long visitFixedPointOperator(FixedPointOperator op, Void arg) throws AlgebricksException {
        // We do not know the number of iterations apriori.
        return UNKNOWN;
    }

    @Override
    public Long visitRecursiveTailOperator(RecursiveTailOperator op, Void arg) throws AlgebricksException {
        // We do not know the number of iterations apriori.
        return UNKNOWN;
    }

    @Override
    public Long visitRecursiveHeadOperator(RecursiveHeadOperator op, Void arg) throws AlgebricksException {
        // We do not know the number of iterations apriori.
        return UNKNOWN;
    }
