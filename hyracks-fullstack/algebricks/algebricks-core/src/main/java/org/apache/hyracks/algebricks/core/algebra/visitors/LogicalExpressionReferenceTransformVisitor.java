...
public abstract class LogicalExpressionReferenceTransformVisitor
    ...
    @Override
    public Boolean visitMarkerSinkOperator(MarkerSinkOperator op, ILogicalExpressionReferenceTransform arg)
            throws AlgebricksException {
        return visitOperator(op, arg);
    }
    ...
    @Override
    public Boolean visitFixedPointOperator(FixedPointOperator op, ILogicalExpressionReferenceTransform arg)
            throws AlgebricksException {
        return visitOperator(op, arg);
    }

    @Override
    public Boolean visitRecursiveTailOperator(RecursiveTailOperator op, ILogicalExpressionReferenceTransform arg)
            throws AlgebricksException {
        return visitOperator(op, arg);
    }

    @Override
    public Boolean visitRecursiveHeadOperator(RecursiveHeadOperator op, ILogicalExpressionReferenceTransform arg)
            throws AlgebricksException {
        return visitOperator(op, arg);
    }
