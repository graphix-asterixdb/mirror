...
public interface ILogicalOperatorVisitor<R, T> {
    ...
    public R visitMarkerSinkOperator(MarkerSinkOperator op, T arg) throws AlgebricksException;
    ...
    public R visitFixedPointOperator(FixedPointOperator op, T arg) throws AlgebricksException;

    public R visitRecursiveTailOperator(RecursiveTailOperator op, T arg) throws AlgebricksException;

    public R visitRecursiveHeadOperator(RecursiveHeadOperator op, T arg) throws AlgebricksException;
