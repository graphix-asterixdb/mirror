...
public class LogicalPropertiesVisitor implements ILogicalOperatorVisitor<Void, IOptimizationContext> {
    ...
    @Override
    public Void visitMarkerSinkOperator(MarkerSinkOperator op, IOptimizationContext arg) throws AlgebricksException {
        return null;
    }
    ...
    @Override
    public Void visitFixedPointOperator(FixedPointOperator op, IOptimizationContext arg) throws AlgebricksException {
        return null;
    }

    @Override
    public Void visitRecursiveTailOperator(RecursiveTailOperator op, IOptimizationContext arg)
            throws AlgebricksException {
        return null;
    }

    @Override
    public Void visitRecursiveHeadOperator(RecursiveHeadOperator op, IOptimizationContext arg)
            throws AlgebricksException {
        return null;
    }
