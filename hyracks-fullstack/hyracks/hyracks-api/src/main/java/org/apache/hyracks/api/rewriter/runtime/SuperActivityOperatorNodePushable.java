...
public class SuperActivityOperatorNodePushable implements IOperatorNodePushable {
    ...
    private void init() throws HyracksDataException {
        ...
        Set<Pair<Pair<IActivity, Integer>, Pair<IActivity, Integer>>> visited = new HashSet<>();
        ...
        for (Entry<ActivityId, IActivity> entry : startActivities.entrySet()) {
            ...
            for (IConnectorDescriptor conn : outputConnectors) {
                ...
                visited.add(childQueue.peekLast());
            }
        }

        /*
         * Using BFS (breadth-first search) to construct to runtime execution graph...
         */
        while (!childQueue.isEmpty()) {
            ...
            for (IConnectorDescriptor conn : outputConnectors) {
                if (conn != null) {
                    Pair<Pair<IActivity, Integer>, Pair<IActivity, Integer>> child =
                            parent.getConnectorActivityMap().get(conn.getConnectorId());
