...
public interface FrameConstants {
    ...
    /**
     * The byte array below represents the maximum integer value-- we do not expect conflicts here with the tuple-count.
     */
    byte[] MESSAGE_FRAME_IDENTIFIER_VALUE = new byte[] { (byte) 0xFF, (byte) 0xFF, (byte) 0xFF, (byte) 0xFF };
}
